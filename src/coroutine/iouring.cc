...
int swoole_coroutine_iouring_open(const char *pathname, int flags, mode_t mode) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_OPENAT, pathname, nullptr, nullptr, flags, mode);
}
...
int swoole_coroutine_iouring_close_file(int fd) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_CLOSE, fd);
}
...
ssize_t swoole_coroutine_iouring_read(int sockfd, void *buf, size_t count) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_READ, sockfd, count, buf);
}
...
ssize_t swoole_coroutine_iouring_write(int sockfd, const void *buf, size_t count) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_WRITE, sockfd, count, nullptr, buf);
}
...
int swoole_coroutine_iouring_rename(const char *oldpath, const char *newpath) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_RENAMEAT, oldpath, newpath);
}
...
int swoole_coroutine_iouring_mkdir(const char *pathname, mode_t mode) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_MKDIRAT, pathname, nullptr, nullptr, 0, mode);
}
...
int swoole_coroutine_iouring_unlink(const char *pathname) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_UNLINK_FILE, pathname);
}
...
int swoole_coroutine_iouring_fstat(int fd, struct stat *statbuf) {
    ...
    int retval = AsyncIouring::async(AsyncIouring::SW_IORING_OP_FSTAT, fd, 0, nullptr, nullptr, &statxbuf);
...
int swoole_coroutine_iouring_stat(const char *path, struct stat *statbuf) {
    ...
    struct statx statxbuf = {};
    int retval = AsyncIouring::async(AsyncIouring::SW_IORING_OP_LSTAT, path, nullptr, &statxbuf);
    swoole_statx_to_stat(&statxbuf, statbuf);
    return retval;
}
...
int swoole_coroutine_iouring_rmdir(const char *pathname) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_UNLINK_DIR, pathname);
}
...
int swoole_coroutine_iouring_fsync(int fd) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_FSYNC, fd);
}
...
int swoole_coroutine_iouring_fdatasync(int fd) {
    ...
    return AsyncIouring::async(AsyncIouring::SW_IORING_OP_FDATASYNC, fd);
}
#endif
